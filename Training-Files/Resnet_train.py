...
config = dict(
    train_path = '../../../dataset/RetinaEyeDataset/Training_Set/Training_Set/Training',
    val_path = '../../../dataset/RetinaEyeDataset/Evaluation_Set/Evaluation_Set/Validation',
    test_path = '../../../dataset/RetinaEyeDataset/Test_Set/Test_Set/Test',
    train_csv = '../../../dataset/RetinaEyeDataset/Training_Set/Training_Set/RFMiD_Training_Labels.csv',
    val_csv = '../../../dataset/RetinaEyeDataset/Evaluation_Set/Evaluation_Set/RFMiD_Validation_Labels.csv',
    test_csv= '../../../dataset/RetinaEyeDataset/Test_Set/Test_Set/RFMiD_Testing_Labels.csv',
    BATCH_SIZE=8,
    IMAGE_HEIGHT= 512,
    IMAGE_WIDTH = 770,
    lr=0.001,
    ...
    SEED=42,
    return_logs=True,
    saved_path = '../saved-models/resnet_v1.pth',
    loss_acc_path = '../roc_loss_plots/loss-acc-resnet.svg',
    roc_path = '../roc_loss_plots/roc-resnet.svg',
    fta_path = '../pickle-files-roc/fta_resnet.pkl'
)
